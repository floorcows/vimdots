...
let g:colors_name='cnord'

hi ColorColumn guifg=NONE ctermfg=NONE guibg=#3b4252 ctermbg=238 gui=NONE cterm=NONE
hi Cursor guifg=#20233a ctermfg=235 guibg=#d8dee9 ctermbg=254 gui=NONE cterm=NONE
...
hi Normal guifg=#d8dee9 ctermfg=254 guibg=#20233a ctermbg=235 gui=NONE cterm=NONE
...
hi SpellBad guifg=#bf616a ctermfg=131 guibg=#20233a ctermbg=235 gui=underline cterm=underline
hi SpellCap guifg=#ebcb8b ctermfg=222 guibg=#88c0d0 ctermbg=110 gui=underline cterm=underline
hi SpellLocal guifg=#e5e9f0 ctermfg=255 guibg=#20233a ctermbg=235 gui=underline cterm=underline
hi SpellRare guifg=#eceff4 ctermfg=255 guibg=#20233a ctermbg=235 gui=underline cterm=underline
...
hi QuickFixLine guifg=#20233a ctermfg=235 guibg=#ebcb8b ctermbg=222 gui=NONE cterm=NONE
hi Terminal guifg=#eceff4 ctermfg=255 guibg=#20233a ctermbg=235 gui=NONE cterm=NONE
...
hi Folded guifg=#4c566a ctermfg=240 guibg=#20233a ctermbg=235 gui=NONE cterm=NONE
hi FoldColumn guifg=#4c566a ctermfg=240 guibg=#20233a ctermbg=235 gui=NONE cterm=NONE
hi SignColumn guifg=#3b4252 ctermfg=238 guibg=#20233a ctermbg=235 gui=NONE cterm=NONE
...
hi WarningMsg guifg=#20233a ctermfg=235 guibg=#ebcb8b ctermbg=222 gui=NONE cterm=NONE
hi WildMenu guifg=#88c0d0 ctermfg=110 guibg=#3b4252 ctermbg=238 gui=NONE cterm=NONE
hi IncSearch guifg=#20233a ctermfg=235 guibg=#ebcb8b ctermbg=222 gui=underline cterm=underline
hi Search guifg=#20233a ctermfg=235 guibg=#ebcb8b ctermbg=222 gui=NONE cterm=NONE
hi TabLine guifg=#303030 ctermfg=254 guibg=#20233a ctermbg=238 gui=NONE cterm=NONE
hi TabLineFill guifg=#303030 ctermfg=254 guibg=#20233a ctermbg=238 gui=NONE cterm=NONE
hi TabLineSel guifg=#303030 ctermfg=110 guibg=#f29db4 ctermbg=240 gui=NONE cterm=NONE
hi Title guifg=#d8dee9 ctermfg=254 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi VertSplit guifg=#434c5e ctermfg=239 guibg=#20233a ctermbg=235 gui=NONE cterm=NONE
